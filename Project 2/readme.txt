...
The receptionist and nurse thread take a long time to initialize for some reason. 
	It may seem like the receptionist is waiting for all patient threads to enter before registering but its not.
	The nurse thread may seem like its waiting for all patients to register but its not.
